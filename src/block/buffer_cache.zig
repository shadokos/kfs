...
const logger = @import("std").log.scoped(.buffer_cache);
...
pub const Buffer = struct {
    ...
    pub const Flags = packed struct {
        valid: bool = false, // Contains valid data
        dirty: bool = false, // Needs writeback
        locked: bool = false, // Currently in I/O
        err: bool = false, // I/O error occurred
        uptodate: bool = false, // Data is current
        _padding: u3 = 0,
    };
...
const BUFFER_POOL_SIZE = MAX_BUFFERS * 4096; // Assuming max 4KB blocks
