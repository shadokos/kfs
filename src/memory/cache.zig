...
pub const Cache = struct {
    ...
    pub fn init(name: []const u8, allocator: *VirtualPageAllocatorType, obj_size: usize, order: u5) Error!Cache {
        var new = Cache{
            .allocator = allocator,
    ...
    pub fn grow(self: *Self, nb_slab: usize) !void {
        for (0..nb_slab) |_| {
            const obj = try self.allocator.alloc_pages(self.pages_per_slab);
