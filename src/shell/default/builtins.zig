...
pub fn stack(_: anytype, _: [][]u8) CmdError!void {
    @import("../../debug.zig").dumpCurrentStackTraceVerbose() catch {};
}
...
pub fn hexdump(_: anytype, args: [][]u8) CmdError!void {
    ...
    @import("../../debug.zig").memory_dump(begin, begin +| len, .Address);
}
...
pub fn pci(shell: anytype, args: [][]u8) CmdError!void {
    ...
    return switch (args.len) {
        ...
        2 => b: {
            ...
            const device_id = std.fmt.parseInt(u16, args[1], 0) catch break :b CmdError.InvalidParameter;
            const device = _pci.get_device(device_id) orelse {
