...
C<[>, L<C<basename>|/"basename">, L<C<cat>|/"cat">, L<C<chmod>|/"chmod">, L<C<chown>|/"chown">, L<C<cp>|/"cp">, L<C<cut>|/"cut">, L<C<dirname>|/"dirname">, L<C<echo>|/"echo">, L<C<env>|/"env">, C<false>,
L<C<fold>|/"fold">, L<C<groups>|/"groups">, L<C<head>|/"head">, L<C<id>|/"id">, L<C<ln>|/"ln">, L<C<logname>|/"logname">, L<C<ls>|/"ls">, L<C<mkdir>|/"mkdir">, L<C<mkfifo>|/"mkfifo">, L<C<mv>|/"mv">, L<C<od>|/"od">,
L<C<paste>|/"paste">, L<C<printf>|/"printf">, L<C<pwd>|/"pwd">, L<C<readlink>|/"readlink">, L<C<realpath>|/"realpath">, L<C<rm>|/"rm">, L<C<rmdir>|/"rmdir">, L<C<sed>|/"sed">, L<C<seq>|/"seq">, L<C<sh>|/"sh">,
L<C<sleep>|/"sleep">, L<C<sort>|/"sort">, L<C<split>|/"split">, L<C<tac>|/"tac">, L<C<tail>|/"tail">, L<C<tee>|/"tee">, C<test>, L<C<touch>|/"touch">, L<C<tr>|/"tr">, C<true>, L<C<truncate>|/"truncate">,
L<C<uniq>|/"uniq">, L<C<unlink>|/"unlink">, L<C<usleep>|/"usleep">, L<C<vi>|/"vi">, L<C<wc>|/"wc">, L<C<whoami>|/"whoami">, L<C<yes>|/"yes">
